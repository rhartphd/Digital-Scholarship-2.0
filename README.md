...
- `data/` — Open, nonrestricted datasets for demonstration.
- `docs/` — Documentation, syllabi, and workshop guides.
- `results/` — Outputs (figures, tables, sample results).
- `assets/` — Logos, diagrams, and images.
- `website/` — Source for the GitHub Pages site.

## License
This repository is released under the [MIT License](LICENSE).  
All text and educational content are shared under [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/).

## Citation
If you use or adapt materials from this repository, please cite:
> Hart, Roger. *Digital Scholarship 2.0: Beyond Coding to Critical Research Tools*. Texas Southern University, 2025. https://github.com/rhartphd/Digital-Scholarship-2.0
